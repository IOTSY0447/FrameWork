...
namespace komal.test {
    public class TestAD : MonoBehaviour 
    {
        ...
        public void ShowInterstitial(){
            komal.sdk.SDKManager.Instance.ShowInterstitial((komal.sdk.ADResult.InterstitialResult result)=>{
                Debug.Log("Test showInterstitial ResultAD: " + result.ToString());
            });
        }

        public void ShowRewardedVideo(){
            komal.sdk.SDKManager.Instance.ShowRewardedVideo((komal.sdk.ADResult.RewardedVideoResult result)=>{
